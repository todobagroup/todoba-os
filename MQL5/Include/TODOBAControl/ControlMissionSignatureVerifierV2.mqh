#ifndef TODOBA_CONTROL_MISSION_SIGNATURE_VERIFIER_V2_MQH
#define TODOBA_CONTROL_MISSION_SIGNATURE_VERIFIER_V2_MQH


#include <TODOBAControl/ControlMissionSigningPayloadV2.mqh>


class TODOBAControlMissionSignatureVerifierV2
{
private:
...
public:
   ...
   )
   {
      ...
      string payload =
         TODOBAControlMissionSigningPayloadV2::Build(
            mission
         );
