"""
TODOBA Control Mission Delivery Redelivery Processor

Redelivers control missions whose delivery leases
...
- recover the original control mission
...
class ControlMissionDeliveryRedeliveryProcessor:
    """
    Redeliver one expired control mission lease.
    """
        ...
        *,
        ...
        if not isinstance(
            ...
            raise TypeError(
                ...
                "requires ControlMissionRepository."
            )
        ...
        if not isinstance(
            ...
            raise TypeError(
                "ControlMissionDeliveryRedeliveryProcessor "
                "requires ControlMissionDeliveryBridge."
            )
