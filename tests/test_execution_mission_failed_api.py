...
def build_mission(
    ...
    return ExecutionMission(
        ...
        tp=4200.0,
        magic_number=10001,
        comment="TODOBA failed API test",
        sequence=1,
        created_at="2026-07-31T00:00:00Z",
        expires_at="2026-07-31T00:40:00Z",
    )
...
def test_execution_mission_failed_api_rejects_missing_credentials(
    tmp_path: Path,
) -> None:
    client, store, persistence = build_client(
        tmp_path
...
def test_execution_mission_failed_api_rejects_wrong_agent_identity(
    tmp_path: Path,
) -> None:
    client, store, persistence = build_client(
        tmp_path
...
def test_execution_mission_failed_api_rejects_mission_owned_by_other_agent(
    tmp_path: Path,
) -> None:
    client, store, persistence = build_client(
        tmp_path,
