#ifndef TODOBA_CONTROL_MISSION_SIGNATURE_VERIFIER_MQH
#define TODOBA_CONTROL_MISSION_SIGNATURE_VERIFIER_MQH


#include <TODOBAControl/ControlMissionParser.mqh>
#include <TODOBAControl/ControlMissionSigningPayload.mqh>


class TODOBAControlMissionSignatureVerifier
{
private:
...
public:
   ...
   )
   {
      ...
      string payload =
         TODOBAControlMissionSigningPayload::Build(
            mission
         );
