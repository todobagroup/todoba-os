#ifndef TODOBA_EXECUTION_MISSION_SIGNATURE_VERIFIER_V2_MQH
#define TODOBA_EXECUTION_MISSION_SIGNATURE_VERIFIER_V2_MQH


#include <TODOBAExecution/ExecutionMissionSigningPayloadV2.mqh>


class TODOBAExecutionMissionSignatureVerifierV2
{
private:
